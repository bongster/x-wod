    ...
    return (
      <div className="starter-template">
        <div className="container">
            ...
            <div className="row flex-nowrap justify-content-between align-items-center">
              ...
              <div className="col-4 d-flex justify-content-end align-items-center">
                <a className="text-muted" href="#">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeidth="2" className="mx-3" role="img" viewBox="0 0 24 24" focusable="false"><title>Search</title><circle cx="10.5" cy="10.5" r="7.5"></circle><path d="M21 21l-5.2-5.2"></path></svg>
                </a>
          ...
          <Jumbotron className="jumbotron p-4 p-md-5 text-white rounded bg-dark">
